...
Parse.Cloud.define("youtubeCategories", async (request) => {
...
Parse.Cloud.define("youtubeTrending", async (request) => {
    var countryCode = request.params.countryCode;
    if (countryCode) {
...
Parse.Cloud.define("youtubeSearch", async (request) => {
...
Parse.Cloud.define("fetchYoutubeVideoDetails", async (request) => {

    var youtubeId = request.params.youtubeId;
    if(!youtubeId){
        throw "please supply the youtubeId"
    }else{
        ...
        Parse.Cloud.httpRequest({
            ...
            if(data.items.length>0){
                ...
                throw "No Video found !! please verify youtubeId"
            }
