...
Parse.Cloud.define("adminAppConfig", async (request) => {
    var json = {}
...
Parse.Cloud.define("statistics", async (request) => {
    ...
    if (appId) {
        ...
        var jsonData = {}
        return app.fetch().then(function(object) {
...
Parse.Cloud.define("statisticsEditor", async (request)  => {
