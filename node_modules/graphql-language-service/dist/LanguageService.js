...
class LanguageService {
    constructor({ parser, schemaLoader, schemaBuilder, schemaConfig, schemaString, parseOptions, exteralFragmentDefinitions, }) {
        ...
        this.getCompletion = (_uri, documentText, position) => __awaiter(this, void 0, void 0, function* () {
            ...
            return graphql_language_service_interface_1.getAutocompleteSuggestions(schema, documentText, position, undefined, yield this.getExternalFragmentDefinitions());
        });
        this.getDiagnostics = (_uri, documentText, customRules) => __awaiter(this, void 0, void 0, function* () {
            ...
            return graphql_language_service_interface_1.getDiagnostics(documentText, schema, customRules);
        });
        this.getHover = (_uri, documentText, position, options) => __awaiter(this, void 0, void 0, function* () {
            return graphql_language_service_interface_1.getHoverInformation((yield this.getSchema()), documentText, position, undefined, Object.assign({ useMarkdown: true }, options));
        });
    ...
    getExternalFragmentDefinitions() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._exteralFragmentDefinitionNodes &&
                ...
                try {
                    graphql_1.visit(yield this._parser(this._exteralFragmentDefinitionsString), {
