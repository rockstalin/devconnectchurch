...
export declare class LanguageService {
    ...
    getHover: (_uri: string, documentText: string, position: IPosition, options?: HoverConfig | undefined) => Promise<string | import("vscode-languageserver-types").MarkupContent | {
        language: string;
        value: string;
