...
// Certificate
// const privateKey = fs.readFileSync('/etc/letsencrypt/live/api.connectchurch.in/privkey.pem', 'utf8');
// const certificate = fs.readFileSync('/etc/letsencrypt/live/api.connectchurch.in/cert.pem', 'utf8');
// const ca = fs.readFileSync('/etc/letsencrypt/live/api.connectchurch.in/chain.pem', 'utf8');
...
httpServer.listen(cons.PORT, async () => {
    var msg = await Parse.Cloud.run("addDefaultAdmin", {})
    console.log(msg)
});
